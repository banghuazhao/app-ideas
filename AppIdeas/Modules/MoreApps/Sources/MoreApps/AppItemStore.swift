...
public struct AppItemStore {
    public static let allItems = [
        AppItem(
            title: String(localized: "Longevity Master", bundle: .module),
            detail: String(localized: "Healthy Habits for Long Life", bundle: .module),
            icon: UIImage(named: "appIcon_longevity_master", in: .module, with: nil),
